...
const Footer = () => {
  ...
  {/* Original Circles */}
  <div
    className="animate-pulse absolute top-5 left-5  md:top-5 md:left-55 w-15 h-15 md:w-34 md:h-34 rounded-full bg-blue-600 opacity-1"
...
<div
    className="animate-pulse absolute top-34 right-95 w-24 h-24 md:w-35 md:h-35 rounded-full bg-blue-300 opacity-10"
    style={{ animationDelay: '2s', animationDuration: '8s' }}
  ></div>
  
  <div
  className="animate-pulse absolute top-55 right-50 w-55 h-55  rounded-full bg-blue-200 opacity-0 block md:hidden"
  style={{ animationDelay: '2s', animationDuration: '9s' }}
></div>

  {/* New Circles */}
  <div
    className="animate-pulse absolute top-5 right-10 md:top-1/8 md:left-2/5 w-17 h-17 md:w-40 md:h-40 rounded-full bg-blue-500 opacity-10"

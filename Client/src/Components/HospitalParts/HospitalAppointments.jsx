...
export default function HospitalAppointments({ appointments }) {
    ...
    return (
        ...
        >
            {/* Title */}
            <h2 className="text-2xl text-center font-bold mb-1">Next Appointments</h2>
            ...
            <div className="flex justify-end mt-4">
                <motion.button
                    className="relative right-7 bg-blue-600 text-white px-5 py-2 rounded-xl text-sm shadow-md hover:bg-blue-700 transition duration-200"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}

...
const testimonials = [
  { 
    name: "Alice Johnson", 
    role: "Fitness Coach",
    feedback: "MediCheck helped me track my health like never before! The insights have been invaluable for my training.",
    image: "/api/placeholder/64/64" 
  },
  { 
    name: "Bob Martinez", 
    role: "Marathon Runner",
    feedback: "Simple, elegant, and potentially life-saving features. The heart rate alerts caught an irregularity I wasn't aware of.", 
    image: "/api/placeholder/64/64" 
  },
  { 
    name: "Carla Wong", 
    role: "Tech Professional",
    feedback: "Love how seamlessly it connects with my watch! The dashboard gives me exactly what I need at a glance.", 
    image: "/api/placeholder/64/64" 
  },
];
    ...
    return (
      <div className="px-6 py-8">
        ...
        <div className="max-w-6xl mx-auto mt-12 bg-white rounded-2xl shadow-md p-8">
          ...
          <p className="mt-2 text-gray-600">Access your real-time health data and insights below.</p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <div className="h-48 flex items-center justify-center border border-dashed border-blue-300 rounded-lg mt-3">
                <p className="text-blue-400">Your recent activities will appear here</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <Navbar join={true}/>
      ...
      <section className="relative bg-gradient-to-br from-blue-500 to-indigo-600 text-white py-24 px-6">
        <div className="max-w-5xl mx-auto text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">Your Personal Health Monitor, Always On Guard</h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto text-blue-100">
            MediCheck helps you monitor your vitals, connect devices, and stay ahead of health concerns with personalized insights.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
            <Link to="/register">
              <button className="w-full sm:w-auto bg-white text-blue-600 px-8 py-3 rounded-xl font-bold hover:bg-blue-50 transition shadow-lg">
                Get Started Free
              </button>
            </Link>
            <Link to="/learn-more">
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-800">Comprehensive Health Monitoring</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, i) => (
              <div key={i} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border-t-4 border-blue-500">
      ...
      <section className="py-16 px-6 bg-blue-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-800">How MediCheck Works</h2>
            <p className="mt-3 text-gray-600 max-w-2xl mx-auto">
              Get started in just three simple steps and take control of your health journey.
            </p>
          </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-gray-600 max-w-2xl mx-auto">
              Join thousands of satisfied users who have transformed their health monitoring experience.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-800">Why Choose MediCheck</h2>
            <p className="mt-3 text-gray-600 max-w-2xl mx-auto">
              Our platform stands out with features designed for reliability and ease of use.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h2 className="text-3xl font-bold">Ready to Take Charge of Your Health?</h2>
          <p className="text-blue-100 text-lg">
            Join thousands of users who are proactively managing their health with MediCheck.
          </p>
          <div className="pt-4">
            <Link to="/register">
            ...
            <p className="mt-4 text-sm text-blue-200">No credit card required. Free plan available.</p>
          </div>
        </div>
      </section>
